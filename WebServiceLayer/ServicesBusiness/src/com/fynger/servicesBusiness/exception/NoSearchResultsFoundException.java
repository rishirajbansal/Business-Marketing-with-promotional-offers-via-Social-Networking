...
public class NoSearchResultsFoundException extends ApplicationException {
	...
	/**
     * Constructor for NoSearchResultsFoundException
     * @param msg - Message associated with the exception
     */
    public NoSearchResultsFoundException(String msg) {
    	super(msg);
    	error = msg;
    }

    /**
     * Initializes a newly created <code>NoSearchResultsFoundException</code> object.
     * @param	msg - the message associated with the Exception.
     * @param   cause - Throwable object
     */
    public NoSearchResultsFoundException(String msg, Throwable cause) {
    	super(msg, cause);
    }
    
    /**
     * Constructor for NoSearchResultsFoundException to set exceptionDetail
     */
    public NoSearchResultsFoundException(ExceptionDetail exceptionDetail) {

...
public class MailConfigurationException extends ApplicationException {
	...
	/**
     * Constructor for MailConfigurationException
    ...
    /**
     * Initializes a newly created <code>MailConfigurationException</code> object.
     * @param	msg - the message associated with the Exception.
     * @param   cause - Throwable object
     */
    public MailConfigurationException(String msg, Throwable cause) {
    	super(msg, cause);
    }
    
    /**
     * Constructor for MailConfigurationException to set exceptionDetail
     */
    public MailConfigurationException(ExceptionDetail exceptionDetail) {

...
public class LocationNotFoundException extends ApplicationException {
	...
	/**
     * Constructor for LocationNotFoundException
    ...
    /**
     * Initializes a newly created <code>LocationNotFoundException</code> object.
     * @param	msg - the message associated with the Exception.
     * @param   cause - Throwable object
     */
    public LocationNotFoundException(String msg, Throwable cause) {
    	super(msg, cause);
    }
    
    /**
     * Constructor for LocationNotFoundException to set exceptionDetail
     */
    public LocationNotFoundException(ExceptionDetail exceptionDetail) {
